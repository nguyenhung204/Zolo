...
Xóa một thành viên khỏi nhóm. **OWNER** có thể kick bất kỳ ai (trừ chính mình). **ADMIN** có thể kick MEMBER và MODERATOR.
...
| `newRole` | `"owner"` \| `"admin"` \| `"moderator"` \| `"member"` | Role mới |
